...
const QUICK_LINKS = [
    ...
    { icon:'📮', title:'건의함',                  desc:'웹사이트 피드백 및 건의사항', url:'https://docs.google.com/forms/d/e/1FAIpQLScUFM4zrlhQRJrgg0bXX33IiNY2nynXp4STqQsypHCHFb7byQ/viewform', color:'#14b8a6' }
];
